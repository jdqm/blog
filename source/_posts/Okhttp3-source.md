---
title: Okhttp3源码分析
date: 2018-04-29 16:43:29
updated: 2018-04-29 16:43:29
tags:
    -源码分析
    -开源项目
    -Okhttp3
...
```
另外还有一个线程池 executorService ，这个线程池跟Android中的CachedThreadPool非常类似，这种类型的线程池，适用于大量的耗时较短的异步任务。[下一篇文章][1] 将对OkHttp框架中的线程池做一个总结。
...
紧接着通过 OkHttpClient 和 Request 构造一个 Call 对象，它的实现是RealCall
```
...
[1]: https://www.jianshu.com/p/9deec36f2759
[2]: https://upload-images.jianshu.io/upload_images/3631399-0626631d246373a4.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240
[3]: https://upload-images.jianshu.io/upload_images/3631399-164b722ab35ae9bf.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240
